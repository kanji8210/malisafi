...
return array(
    ...
    'MalisafiMLS\\Agency_Management_Admin' => $baseDir . '/admin/class-agency-management-admin.php',
    'MalisafiMLS\\Agency_Manager' => $baseDir . '/includes/class-agency-manager.php',
    'MalisafiMLS\\Agency_Membership_Admin' => $baseDir . '/admin/class-agency-membership-admin.php',
    'MalisafiMLS\\Agency_Membership_Manager' => $baseDir . '/includes/class-agency-membership-manager.php',
    'MalisafiMLS\\Agent_Actions_Ajax' => $baseDir . '/includes/class-agent-actions-ajax.php',
    'MalisafiMLS\\Agent_Post_Type' => $baseDir . '/includes/class-agent-post-type.php',
    'MalisafiMLS\\Agent_Profile_Ajax' => $baseDir . '/includes/class-agent-profile-ajax.php',
    'MalisafiMLS\\Agent_Settings_Ajax' => $baseDir . '/includes/ajax/class-agent-settings-ajax.php',
    'MalisafiMLS\\Analytics\\Analytics_Admin' => $baseDir . '/includes/analytics/class-analytics-admin.php',
    'MalisafiMLS\\Analytics\\Analytics_Advanced' => $baseDir . '/includes/analytics/class-analytics-advanced.php',
    'MalisafiMLS\\Analytics\\Analytics_Core' => $baseDir . '/includes/analytics/class-analytics-core.php',
    'MalisafiMLS\\Analytics\\Analytics_Database' => $baseDir . '/includes/analytics/class-analytics-database.php',
    'MalisafiMLS\\Analytics\\Analytics_Migration' => $baseDir . '/includes/analytics/class-analytics-migration.php',
    'MalisafiMLS\\Analytics\\Analytics_Properties' => $baseDir . '/includes/analytics/class-analytics-properties.php',
    'MalisafiMLS\\Analytics\\Analytics_Sync' => $baseDir . '/includes/analytics/class-analytics-sync.php',
    'MalisafiMLS\\Analytics\\Analytics_Tracker' => $baseDir . '/includes/analytics/class-analytics-tracker.php',
    'MalisafiMLS\\Cache_Manager' => $baseDir . '/includes/class-cache-manager.php',
    'MalisafiMLS\\Core' => $baseDir . '/includes/class-core.php',
    'MalisafiMLS\\Dashboard_Shortcodes' => $baseDir . '/includes/class-dashboard-shortcodes.php',
    'MalisafiMLS\\Database' => $baseDir . '/includes/class-database.php',
    'MalisafiMLS\\Deactivator' => $baseDir . '/includes/class-deactivator.php',
    'MalisafiMLS\\Email_Settings' => $baseDir . '/includes/class-email-settings.php',
    'MalisafiMLS\\Featured_Properties' => $baseDir . '/includes/class-featured-properties.php',
    'MalisafiMLS\\Fraud_Report_Ajax' => $baseDir . '/includes/class-fraud-report-ajax.php',
    'MalisafiMLS\\I18n' => $baseDir . '/includes/class-i18n.php',
    'MalisafiMLS\\Image_Handler' => $baseDir . '/includes/class-image_handler.php',
    'MalisafiMLS\\Loader' => $baseDir . '/includes/class-loader.php',
    'MalisafiMLS\\Login_Customizer' => $baseDir . '/includes/class-login-customizer.php',
    'MalisafiMLS\\Page_Manager' => $baseDir . '/includes/class-page-manager.php',
    'MalisafiMLS\\Post_Types' => $baseDir . '/includes/class-post-types.php',
    'MalisafiMLS\\Project_Submission' => $baseDir . '/includes/class-project-submission.php',
    'MalisafiMLS\\Property_Access_Control' => $baseDir . '/includes/class-property-access-control.php',
    'MalisafiMLS\\Property_Actions_Ajax' => $baseDir . '/includes/class-property-actions-ajax.php',
    'MalisafiMLS\\Property_Filters_Ajax' => $baseDir . '/includes/class-property-filters-ajax.php',
    'MalisafiMLS\\Property_Manager' => $baseDir . '/includes/class-property-manager.php',
    'MalisafiMLS\\Property_Submission' => $baseDir . '/includes/class-property-submission.php',
    'MalisafiMLS\\Property_Success' => $baseDir . '/admin/class-property-success.php',
    'MalisafiMLS\\Reference_ID' => $baseDir . '/includes/class-reference-id.php',
    'MalisafiMLS\\User_Creation_Helper' => $baseDir . '/includes/class-user-creation-helper.php',
    'MalisafiMLS\\Validator' => $baseDir . '/includes/class-validator.php',
    'Malisafi_Admin_Dashboard' => $baseDir . '/admin/class-admin-dashboard.php',
    'Malisafi_Admin_Fraud_Reports' => $baseDir . '/admin/class-admin-fraud-reports.php',
    'Malisafi_Agent_Dashboard' => $baseDir . '/admin/class-agent-dashboard.php',
    'Malisafi_Agent_Management' => $baseDir . '/admin/class-agent-management.php',
    'Malisafi_Agent_Ratings_Admin' => $baseDir . '/admin/class-agent-ratings-admin.php',
    'Malisafi_Dashboard_Widgets' => $baseDir . '/admin/class-dashboard-widgets.php',
    'Malisafi_Fraud_Report_Shortcode' => $baseDir . '/includes/class-fraud-report-shortcode.php',
    'Malisafi_Inquiries_Admin' => $baseDir . '/admin/class-inquiries-admin.php',
    'Malisafi_Project_Submit' => $baseDir . '/admin/class-project-submit.php',
    'Malisafi_Property_Approval_Workflow' => $baseDir . '/includes/class-property-approval-workflow.php',
    ...
    'Malisafi_Registration_Handler' => $baseDir . '/includes/class-registration-handler.php',
