...
class ComposerStaticInit0c935aba6e293e21ee730ece95eb7d2d
{
    ...
    public static $classMap = array (
        ...
        'MalisafiMLS\\Agency_Management_Admin' => __DIR__ . '/../..' . '/admin/class-agency-management-admin.php',
        'MalisafiMLS\\Agency_Manager' => __DIR__ . '/../..' . '/includes/class-agency-manager.php',
        'MalisafiMLS\\Agency_Membership_Admin' => __DIR__ . '/../..' . '/admin/class-agency-membership-admin.php',
        'MalisafiMLS\\Agency_Membership_Manager' => __DIR__ . '/../..' . '/includes/class-agency-membership-manager.php',
        'MalisafiMLS\\Agent_Actions_Ajax' => __DIR__ . '/../..' . '/includes/class-agent-actions-ajax.php',
        'MalisafiMLS\\Agent_Post_Type' => __DIR__ . '/../..' . '/includes/class-agent-post-type.php',
        'MalisafiMLS\\Agent_Profile_Ajax' => __DIR__ . '/../..' . '/includes/class-agent-profile-ajax.php',
        'MalisafiMLS\\Agent_Settings_Ajax' => __DIR__ . '/../..' . '/includes/ajax/class-agent-settings-ajax.php',
        'MalisafiMLS\\Analytics\\Analytics_Admin' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-admin.php',
        'MalisafiMLS\\Analytics\\Analytics_Advanced' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-advanced.php',
        'MalisafiMLS\\Analytics\\Analytics_Core' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-core.php',
        'MalisafiMLS\\Analytics\\Analytics_Database' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-database.php',
        'MalisafiMLS\\Analytics\\Analytics_Migration' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-migration.php',
        'MalisafiMLS\\Analytics\\Analytics_Properties' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-properties.php',
        'MalisafiMLS\\Analytics\\Analytics_Sync' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-sync.php',
        'MalisafiMLS\\Analytics\\Analytics_Tracker' => __DIR__ . '/../..' . '/includes/analytics/class-analytics-tracker.php',
        'MalisafiMLS\\Cache_Manager' => __DIR__ . '/../..' . '/includes/class-cache-manager.php',
        'MalisafiMLS\\Core' => __DIR__ . '/../..' . '/includes/class-core.php',
        'MalisafiMLS\\Dashboard_Shortcodes' => __DIR__ . '/../..' . '/includes/class-dashboard-shortcodes.php',
        'MalisafiMLS\\Database' => __DIR__ . '/../..' . '/includes/class-database.php',
        'MalisafiMLS\\Deactivator' => __DIR__ . '/../..' . '/includes/class-deactivator.php',
        'MalisafiMLS\\Email_Settings' => __DIR__ . '/../..' . '/includes/class-email-settings.php',
        'MalisafiMLS\\Featured_Properties' => __DIR__ . '/../..' . '/includes/class-featured-properties.php',
        'MalisafiMLS\\Fraud_Report_Ajax' => __DIR__ . '/../..' . '/includes/class-fraud-report-ajax.php',
        'MalisafiMLS\\I18n' => __DIR__ . '/../..' . '/includes/class-i18n.php',
        'MalisafiMLS\\Image_Handler' => __DIR__ . '/../..' . '/includes/class-image_handler.php',
        'MalisafiMLS\\Loader' => __DIR__ . '/../..' . '/includes/class-loader.php',
        'MalisafiMLS\\Login_Customizer' => __DIR__ . '/../..' . '/includes/class-login-customizer.php',
        'MalisafiMLS\\Page_Manager' => __DIR__ . '/../..' . '/includes/class-page-manager.php',
        'MalisafiMLS\\Post_Types' => __DIR__ . '/../..' . '/includes/class-post-types.php',
        'MalisafiMLS\\Project_Submission' => __DIR__ . '/../..' . '/includes/class-project-submission.php',
        'MalisafiMLS\\Property_Access_Control' => __DIR__ . '/../..' . '/includes/class-property-access-control.php',
        'MalisafiMLS\\Property_Actions_Ajax' => __DIR__ . '/../..' . '/includes/class-property-actions-ajax.php',
        'MalisafiMLS\\Property_Filters_Ajax' => __DIR__ . '/../..' . '/includes/class-property-filters-ajax.php',
        'MalisafiMLS\\Property_Manager' => __DIR__ . '/../..' . '/includes/class-property-manager.php',
        'MalisafiMLS\\Property_Submission' => __DIR__ . '/../..' . '/includes/class-property-submission.php',
        'MalisafiMLS\\Property_Success' => __DIR__ . '/../..' . '/admin/class-property-success.php',
        'MalisafiMLS\\Reference_ID' => __DIR__ . '/../..' . '/includes/class-reference-id.php',
        'MalisafiMLS\\User_Creation_Helper' => __DIR__ . '/../..' . '/includes/class-user-creation-helper.php',
        'MalisafiMLS\\Validator' => __DIR__ . '/../..' . '/includes/class-validator.php',
        'Malisafi_Admin_Dashboard' => __DIR__ . '/../..' . '/admin/class-admin-dashboard.php',
        'Malisafi_Admin_Fraud_Reports' => __DIR__ . '/../..' . '/admin/class-admin-fraud-reports.php',
        'Malisafi_Agent_Dashboard' => __DIR__ . '/../..' . '/admin/class-agent-dashboard.php',
        'Malisafi_Agent_Management' => __DIR__ . '/../..' . '/admin/class-agent-management.php',
        'Malisafi_Agent_Ratings_Admin' => __DIR__ . '/../..' . '/admin/class-agent-ratings-admin.php',
        'Malisafi_Dashboard_Widgets' => __DIR__ . '/../..' . '/admin/class-dashboard-widgets.php',
        'Malisafi_Fraud_Report_Shortcode' => __DIR__ . '/../..' . '/includes/class-fraud-report-shortcode.php',
        'Malisafi_Inquiries_Admin' => __DIR__ . '/../..' . '/admin/class-inquiries-admin.php',
        'Malisafi_Project_Submit' => __DIR__ . '/../..' . '/admin/class-project-submit.php',
        'Malisafi_Property_Approval_Workflow' => __DIR__ . '/../..' . '/includes/class-property-approval-workflow.php',
        ...
        'Malisafi_Registration_Handler' => __DIR__ . '/../..' . '/includes/class-registration-handler.php',
