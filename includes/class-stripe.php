    ...
    public static function get_plans() {
        ...
        return array(
            'agent_basic' => array(
                ...
                'currency' => 'USD',
                'interval' => 'month',
                'max_listings' => intval(get_option('malisafi_mls_agent_basic_max_listings', 10)),
                'featured_listings' => 0,
                'can_boost' => 0,
                'analytics_access' => 1,
                'features' => array(
                    sprintf(__('%d property listings', 'malisafi-mls'), intval(get_option('malisafi_mls_agent_basic_max_listings', 10))),
            ...
            'agent_premium' => array(
                ...
                'currency' => 'USD',
                'interval' => 'month',
                'max_listings' => intval(get_option('malisafi_mls_agent_premium_max_listings', -1)),
                'featured_listings' => 5,
                'can_boost' => 1,
                'analytics_access' => 1,
                'features' => array(
            ...
            'owner_basic' => array(
                ...
                'currency' => 'USD',
                'interval' => 'month',
                'max_listings' => intval(get_option('malisafi_mls_owner_max_listings', 3)),
                'featured_listings' => 0,
                'can_boost' => 0,
                'analytics_access' => 1,
                'features' => array(
                    sprintf(__('%d property listings', 'malisafi-mls'), intval(get_option('malisafi_mls_owner_max_listings', 3))),
                    __('Basic analytics', 'malisafi-mls'),
                    __('Email support', 'malisafi-mls'),
                ),
            ...
            'developer' => array(
                ...
                'currency' => 'USD',
                'interval' => 'month',
                'max_listings' => intval(get_option('malisafi_mls_developer_max_listings', -1)),
